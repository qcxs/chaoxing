...
# 关闭小窗检测
搜索CLIENT_SNAPSHOT，
![[Pasted image 20251230152728.png]]
在当前结果中搜索enable，选择第二个
![[Pasted image 20251230153105.png]]
转java，可以看出此处设置了enable
![[Pasted image 20251230153215.png]]
this.s的值默认为0，故只需让上述方法不执行即可，清空代码
![[Pasted image 20251230153307.png]]
# 关闭退出检测
同理搜索CLIENT_WEB_LIFECYCLE，并清空
![[Pasted image 20251230153531.png]]

# 其他
之后可以通过内置**自定义js**手动执行closeMonitor()关闭监控。